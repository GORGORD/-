class Graph2DComponent extends Component {
    constructor(options) {
        ...
        this.ui = new UIComponent({
            ...
            callbacks: {
                ...
                addFunction: (f, num, width, color,startLine, endLine) => this.addFunction(f, num, width, color,startLine, endLine),
    ...
    addFunction(f, num, width = 2, color = 'rgb(180, 0, 0)', startLine, endLine) {
        this.funcs[num] = { f, color, width,startLine, endLine };
        this.render();
    }
    ...
    render() {
        ...
        this.funcs.forEach(element => {
            if (element) {
                ...
                this.canvas.line( element.startLine,0 ,element.endLine,0, element.color);
                let xZero = this.getZero(element.f, element.startLine, element.endLine,0.0001);
